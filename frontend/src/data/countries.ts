// Auto-generated from the user-provided country calling codes list.
// Note: "code" is stored WITHOUT area sub-code suffixes (e.g. +1 instead of +1-268)
// because the SIP dialer only needs the numeric international prefix.
